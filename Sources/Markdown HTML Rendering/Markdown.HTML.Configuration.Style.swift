...
extension Markdown.HTML.Configuration.Style {
    ...
    public struct DiagnosticStyle: Sendable {
        public var level: @Sendable (_ name: String) -> Diagnostic.Level?

        public init(_ level: @escaping @Sendable (_ name: String) -> Diagnostic.Level?) {
            self.level = level
        }
        ...
        public func adding(_ name: String, _ diagnosticLevel: Diagnostic.Level) -> Self {
